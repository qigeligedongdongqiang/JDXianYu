...
- (void)setUpAllChildVc
{
    ...
    JDHomeTableViewController *HomeVC = [[JDHomeTableViewController alloc] initWithStyle:UITableViewStyleGrouped showDragRefreshHeader:YES showDragRefreshFooter:YES]  ;
